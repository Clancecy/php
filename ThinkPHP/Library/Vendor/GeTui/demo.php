...
define('APPKEY','4WvFY17VWP6oxISUTuR1L5');
define('APPID','C6VeKDkAPX5ICWQdmEdnk8');
define('MASTERSECRET','dpcoToXu3H9umlBy0uSKn5');
define('HOST','http://sdk.open.api.igexin.com/apiex.htm');
define('CID','946a03a49a3cd2143b7d72e0c3b43c20');
define('DEVICETOKEN','');
define('Alias','捎货小助');
...
function IGtNotificationTemplateDemo(){
        ...
        $template->set_title("捎货小助");//通知栏标题
        $template->set_text("你有新的订单消息，点击查看");//通知栏内容
        $template->set_logo("http://www.shaohuo.net.cn/logo.png");//通知栏logo
        $template->set_isRing(true);//是否响铃
        $template->set_isVibrate(true);//是否震动
        $template->set_isClearable(true);//通知栏是否可清除
        //$template->set_duration(BEGINTIME,ENDTIME); //设置ANDROID客户端在此时间区间内展示消息
